...
# Download the latest model during cold start
def get_latest_model_key():
    # Add Prefix to list only files in the "trained_models/" folder
...
MODEL = torch.load(MODEL_PATH, map_location="cpu")  # Load the PyTorch model
MODEL.eval()
